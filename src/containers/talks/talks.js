      ...
      <div className="main" id="talks">
        <div className="project-main-div">
          <div className="project-header">
            ...
            <p><b>Feb 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://2025.pycascades.com/program/talks/pyladies-panel/" className="no_decor">Panelist</a> @ PyCascades 2025 - '<a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/watch?v=x-xQj6EcQbI" className="no_decor">PyLadies Panel: Talking about experiences and roles within the Python community</a>'</p>
