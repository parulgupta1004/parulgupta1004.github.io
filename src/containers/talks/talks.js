      ...
      <div className="main" id="talks">
        <div className="project-main-div">
          <div className="project-header">
            ...
            <p><b>Sept 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://pretalx.com/pybeach2025/talk/HQ8SAA/" className="no_decor">Speaker</a> @ PyBeach 2025 - '<a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/watch?v=BdTv07T7hmg" className="no_decor">Python Packaging Expressway: A Path Worth Taking</a>'</p>
            <p><b>Jul 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/events/7348038506935382019/about/" className="no_decor">Guest Podcast</a> @ WAITalks, Women in AI - 'Fairness, Open Source & The Real Cost of AI Deployment'</p>
            <p><b>Jul 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://www.scipy2025.scipy.org/" className="no_decor">Presenter</a> @ SciPy Conference 2025 - 'Pythonic Potions: Mastering Scientific Sorcery With Efficient AI Coding'</p>
            ...
            <p><b>Apr 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://pretalx.northbaypython.org/nbpy-2025/speaker/N8CGUX/" className="no_decor">Speaker</a> @ North Bay Python 2025 - '<a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/watch?v=glkTprUyJEM" className="no_decor">Python Scientific Sorcery With Efficient Code</a>'</p>
            <p><b>Apr 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://www.umassai.com/#events" className="no_decor">Invited Workshop</a> @ MassAI, University of Massachusetts Amherst - 'Fairness in AI'</p>
            {/* <p><b>Feb 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/watch?v=XWF8Xy9MyZ4" className="no_decor">Guest Host Speaker</a> @ Two Voice Devs Podcast- 'Episode 228 - AI Ethics: How Developers Can Build Fairer Systems'</p> */}
            ...
            <p><b>Feb 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://www.cics.umass.edu/events/ace-coding-interview-atci" className="no_decor">Invited Workshop</a> @ Career Development Workshop, University of Massachusetts Amherst - 'Ace the Coding Interview (ATCI)'</p>
            <p><b>Feb 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://2025.pycascades.com/program/talks/pyladies-panel/" className="no_decor">Guest Panel</a> @ PyCascades 2025 - '<a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/watch?v=x-xQj6EcQbI" className="no_decor">PyLadies Panel: Talking about experiences and roles within the Python community</a>'</p>
            <p><b>Feb 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://gdg.community.dev/events/details/google-gdg-on-campus-higher-school-of-communication-of-tunis-supcom-ariana-tunisia-presents-ai-odyssey-hackathon/cohost-gdg-on-campus-higher-school-of-communication-of-tunis-supcom-ariana-tunisia" className="no_decor">Keynote Speaker</a> @ AI Odyssey Hackathon 2025, GDG, Sup'Com, Ariana, Tunisia - 'Breaking the Bias: In Tech, In AI and In Society'</p>
            <p><b>Feb 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://www.conf42.com/python2025" className="no_decor">Keynote Speaker</a> @ Conf42 Python 2025 - '<a target="_blank" rel="noopener noreferrer" href="https://www.conf42.com/Python_2025_Parul_Gupta_ai_ml_prototyping" className="no_decor">Accelerating AI Lifecycle: Fast ML Prototyping Insights</a>'</p>
            <p><b>Jan 2025</b>: <a target="_blank" rel="noopener noreferrer" href="https://gdg.community.dev/events/details/google-gdg-on-campus-nanyang-technological-university-singapore-singapore-presents-fairness-in-ai-with-parul-gupta/" className="no_decor">Guest Podcast</a> @ Google Developer Group (GDG), NTU Singapore - '<a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/events/7289910200214396928/" className="no_decor">Fairness in AI with Parul Gupta</a>'</p>
