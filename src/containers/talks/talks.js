      ...
      <div className="main" id="talks">
        <div className="project-main-div">
          <div className="project-header">
            ...
            <div>
            <p><b>Feb 2025</b>: <a target="_blank" rel="noopener noreferrer" href="hhttps://www.youtube.com/watch?v=XWF8Xy9MyZ4" className="no_decor">Guest Host Speaker</a> @ Two Voice Devs Podcast- 'Episode 228 - AI Ethics: How Developers Can Build Fairer Systems'</p>
